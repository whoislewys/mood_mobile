...
class mood_mobileUITests: XCTestCase {
    ...
    func testExample() {
        ...
        // Mood
        Thread.sleep(forTimeInterval:5) // let splash screen fade away
        snapshot("01MoodScreen")
        ...
        Thread.sleep(forTimeInterval:20) // let assets load & render
        snapshot("02LeaderboardScreen")
        ...
        snapshot("04PlayScreen")

        // app.children(matching: .image).element.tap() // wtf generated this boi?
    }
